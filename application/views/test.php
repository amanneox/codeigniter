...
<?php include_once 'include/nav.php'; ?>
    ...
    <li id="buttons" class="nav-item">
      <a class="nav-link active btn btn-primary" id="save"  href="#">Save</a>
    </li>
...
<div class="row">
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="empno" value="<?php echo $row->empno ?>" placeholder="Enter No. of Employees">
          <span class="help-block error text-danger" ><?php echo form_error('empno')?></span>
        </div>
       ...
       <div class="col-sm-6">
        ...
        <div class="form-group">
        <label for="annualrev ">Annual Revenue</label>
        <input type="text" class="form-control" name="annualrev" value="<?php echo $row->annualrev ?>" placeholder="Enter Annual Revenue">
        <span class="help-block error text-danger" ><?php echo form_error('annualrev')?></span>
      </div>
      ...
      <div class="form-group">
        ...
        <span class="help-block error text-danger" ><?php echo form_error('linkedinid')?></span>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rows='4' cols='50' name="notes" value="<?php echo $row->note ?>"  placeholder="Enter Notes"></textarea>
      ...
      foreach ($results as $row)
        {?>
          ...
          <?php
				...
				<div style="padding-right:4em;" class="col-sm-2">
