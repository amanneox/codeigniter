$(function(){
        ...
        editable: true, // Make the event resizable true
         ...
         eventDrop: function(event, delta, revertFunc,start,end) {
            ...
            if(event.end){
               ...
               $.post(base_url+'cal/dragUpdateEvent',{
                id:event.id,
                start : start,
                end :end
            }, function(result){
    ...
    function modal(data) {
        ...
        $('#modal .modal-footer button:not(".btn-default")').remove();
         $('#settime').val(data.event?data.event.current_time:'');
        // Set input values
    ...
    $('#modal').on('click', '#delete-event',  function(e){
        $.get(base_url+'cal/deleteEvent?id=' + currentEvent._id, function(result){
